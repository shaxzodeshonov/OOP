...
window.LESSONS = {
  ...
  home: {
    badge: "2-Day Sprint",
    title: "C++ OOP in 2 Days",
    subtitle: "Concept → Syntax → Rules → Practice → Quiz. The fastest path through a 4-week syllabus.",
    type: "home",
    dayPlan: [
      { label: "Day 1 · ~8 hrs", icon: "🏗️", title: "Classes Fundamentals",
        items: ["OOP concepts (1h)","Classes, objects, members (1.5h)","Encapsulation, getters/setters (1h)","Header & source files (45min)","Constructors & destructors (1.5h)","Const, composition, friends (1.5h)","Static members (45min)"] },
      { label: "Day 2 · ~6 hrs", icon: "⚙️", title: "Advanced + Operators",
        items: ["Review + Quiz 1 & 2 (1h)","Pointers with objects (1h)","Dynamic memory new/delete (1h)","Operator overloading basics (1.5h)","Stream operators << >> (1h)","Unary operators (30min)","Final quiz (1h)"] },
    ],
    tips: [
